...
![Deleting nodes in the Editor window](_static/deletenodes.gif)
...
![Creating an alternating CNOT circuit](_static/create_alternating_cnots.gif)
...
![The ZXLive Proof window](_static/proof_window.png)
...
![The Proof window's toolbar](_static/proof_window_toolbar.png)
...
![The bialgebra rule](_static/bialgebra.gif)
...
![Merging spiders and removing identities](_static/simplify_graph.gif)
...
![Simplify the graph to a SWAP](_static/simplify_to_swap.gif)
...
ZXLive keeps its interface simple by hiding the more specialised features until you ask for them. You can turn them on and off at any time from the **View > Features** menu:

- **Fault-equivalent rewrites** (off by default): adds the fault-equivalent mode toggle to the proof toolbar. See [Fault equivalent rewrites](fault-equivalent-rewrites.md).
