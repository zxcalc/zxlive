...
general_settings: list[SettingsData] = [
    ...
    },
    {
        "id": "dark-mode",
        "label": "Theme",
        "type": FormInputType.Combo,
        "data": dark_mode_options
    },
    {
        "id": "sparkle-mode",
        "label": "Sparkle Mode",
    ...
    },
    {
        ...
        "type": FormInputType.Combo,
        "data": tab_positioning_data
    },
    {
        "id": "path/custom-rules",
        "label": "Custom rules path",
        "type": FormInputType.Folder
    },
    {
        "id": "snap-granularity",
        "label": "Snap-to-grid granularity",
        "type": FormInputType.Combo,
        "data": snap_to_grid_data
    },
    {
        "id": "input-circuit-format",
        "label": "Input Circuit as",
        "type": FormInputType.Combo,
        "data": input_circuit_formats
    },
    {
        "id": "matrix/precision",
        "label": "Matrix display precision",
...
def load_font_families() -> None:
    index = next(
        i for i, d in enumerate(font_settings) if d["id"] == "font/family")
    font_settings[index]["data"] |= {f: f for f in QFontDatabase.families()}


tikz_export_settings: list[SettingsData] = [
    {
        "id": "tikz/Z-spider-export",
        "label": "Z-spider",
        "type": FormInputType.Str
    },
    {
        "id": "tikz/Z-phase-export",
        "label": "Z-spider with phase",
        "type": FormInputType.Str
    },
    {
        "id": "tikz/X-spider-export",
        "label": "X-spider",
        "type": FormInputType.Str
    },
    {
        "id": "tikz/X-phase-export",
        "label": "X-spider with phase",
        "type": FormInputType.Str
    },
    {
        "id": "tikz/Hadamard-export",
        "label": "Hadamard",
        "type": FormInputType.Str
    },
    {
        "id": "tikz/w-input-export",
        "label": "W input",
        "type": FormInputType.Str
    },
    {
        "id": "tikz/w-output-export",
        "label": "W output",
        "type": FormInputType.Str
    },
    {
        "id": "tikz/z-box-export",
        "label": "Z box",
        "type": FormInputType.Str
    },
    {
        "id": "tikz/dummy-export",
        "label": "Dummy node",
        "type": FormInputType.Str
    },
    {
        "id": "tikz/edge-W-export",
        "label": "W io edge",
        "type": FormInputType.Str
    },
]
...
tikz_import_settings: list[SettingsData] = [
    {
        "id": "tikz/Z-spider-import",
        "label": "Z-spider",
        "type": FormInputType.Str
    },
    {
        "id": "tikz/X-spider-import",
        "label": "X-spider",
        "type": FormInputType.Str
    },
    {
        "id": "tikz/Hadamard-import",
        "label": "H-box",
        "type": FormInputType.Str
    },
    {
        "id": "tikz/w-input-import",
        "label": "W input",
        "type": FormInputType.Str
    },
    {
        "id": "tikz/w-output-import",
        "label": "W output",
        "type": FormInputType.Str
    },
    {
        "id": "tikz/z-box-import",
        "label": "Z box",
        "type": FormInputType.Str
    },
    {
        "id": "tikz/dummy-import",
        "label": "Dummy node",
        "type": FormInputType.Str
    },
    {
    ...
    {
        "id": "tikz/edge-H-import",
        "label": "H edge",
        "type": FormInputType.Str
    },
    {
        "id": "tikz/edge-W-import",
        "label": "W io edge",
        "type": FormInputType.Str
    },
]
...
tikz_layout_settings: list[SettingsData] = [
    {
        "id": "tikz/layout/hspace",
        "label": "Horizontal spacing",
        "type": FormInputType.Float
    },
    {
        "id": "tikz/layout/vspace",
        "label": "Vertical spacing",
        "type": FormInputType.Float
    },
    {
        "id": "tikz/layout/max-width",
        "label": "Maximum width",
        "type": FormInputType.Float
    },
]
...
tikz_rule_name_settings: list[SettingsData] = [
    {
        "id": "tikz/names/fuse spiders",
        "label": "fuse spiders",
        "type": FormInputType.Str
    },
    {
        "id": "tikz/names/bialgebra",
        "label": "bialgebra",
        "type": FormInputType.Str
    },
    {
        "id": "tikz/names/change color to Z",
        "label": "change color to Z",
        "type": FormInputType.Str
    },
    {
        "id": "tikz/names/change color to X",
        "label": "change color to X",
        "type": FormInputType.Str
    },
    {
        "id": "tikz/names/remove identity",
        "label": "remove identity",
        "type": FormInputType.Str
    },
    {
        "id": "tikz/names/Add Z identity",
        "label": "add Z identity",
        "type": FormInputType.Str
    },
    {
        "id": "tikz/names/copy 0/pi spider",
        "label": "copy 0/pi spider",
        "type": FormInputType.Str
    },
    {
        "id": "tikz/names/push Pauli",
        "label": "push Pauli",
        "type": FormInputType.Str
    },
    {
        "id": "tikz/names/decompose hadamard",
        "label": "decompose hadamard",
        "type": FormInputType.Str
    },
]
...
class SettingsDialog(QDialog):
    def __init__(self, main_window: MainWindow) -> None:
        ...
        self.prev_tab_bar_location = self.get_settings_value(
            "tab-bar-location", QTabWidget.TabPosition)
        ...
        self.add_settings_tab(
            tab_widget, "General", "General ZXLive settings",
            general_settings)
        self.add_settings_tab(
            tab_widget, "Font", "Font settings", font_settings)
        ...
        self.add_settings_tab(
            tikz_subtab_widget, "Rule names", "Tikz rule name settings",
            tikz_rule_name_settings)
        self.add_settings_tab(
            tikz_subtab_widget, "Export",
            "These are the class names that will be used when exporting "
            "to tikz.", tikz_export_settings)
        self.add_settings_tab(
            tikz_subtab_widget, "Import",
            "These are the class names that are understood when importing "
            "from tikz.", tikz_import_settings)
        self.add_settings_tab(
            tikz_subtab_widget, "Layout", "Tikz layout settings",
            tikz_layout_settings)
        # --- End TikZ nested tab structure ---

        self.init_okay_cancel_buttons(layout)

    def get_settings_value(
            self, arg: str, _type: type[T],
    ...
    def add_settings_tab(
            self, tab_widget: QTabWidget, tab_name: str, label: str,
            data: list[SettingsData]) -> None:
    ...
    def make_folder_form_input(self, data: SettingsData) -> QLineEdit:
        ...
        action = widget_line.addAction(
            QIcon(get_data("icons/folder.svg")),
    ...
    def make_combo_form_input(self, data: SettingsData) -> QComboBox:
        ...
        if defaults[name] is not None:
            default_text = str(defaults[name])
        widget.setCurrentText(_data.get(value, default_text))
        return widget

    def add_setting_to_form(
    ...
    def apply_global_settings(self) -> None:
        ...
        if current_dark_mode != self.prev_dark_mode:
            QMessageBox.information(
                self,
                "Theme Change",
                "You may need to restart the application for the theme "
